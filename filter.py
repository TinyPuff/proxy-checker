...
You may want to copy them and save them in another text file.''')
        ...
        while True:
            print("What protocol are your proxies using?")
            proto = input("> ").upper()
        ...
        while True:
            ...
            try:
                ...
                if choice == 1:
                    ...
                    default_input = "IO/proxies.txt"
                    global default_output
                    default_output = "IO/results.txt"
                    ...
                    result = open(
                        input("Enter the path to the output file: (e.g. C:/Downloads/results.txt)\n> "),
                        'w')
                    break
